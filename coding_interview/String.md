...
A string is a sequence of characters. Many tips that apply to arrays also apply to strings. You're recommended to read the page on [Array](Array.md)s before reading this page.
