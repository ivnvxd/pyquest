...
1. [Basic Data Types](jupyter/01_data_structures_and_data_types.ipynb#basic-dt)
    - [String](jupyter/01_data_structures_and_data_types.ipynb#string)
    - [Number](jupyter/01_data_structures_and_data_types.ipynb#number)
        - [Integer](jupyter/01_data_structures_and_data_types.ipynb#int)
        - [Float](jupyter/01_data_structures_and_data_types.ipynb#float)
        - [Complex](jupyter/01_data_structures_and_data_types.ipynb#complex)
    - [NoneType](jupyter/01_data_structures_and_data_types.ipynb#none)
2. [Built-in Data Structures](jupyter/01_data_structures_and_data_types.ipynb#built-in-ds)
    - [List](jupyter/01_data_structures_and_data_types.ipynb#list)
    - [Tuple](jupyter/01_data_structures_and_data_types.ipynb#tuple)
        - [Named tuple](jupyter/01_data_structures_and_data_types.ipynb#namedtuple)
    - [Dictionary](jupyter/01_data_structures_and_data_types.ipynb#dict)
        - [DefaultDict](jupyter/01_data_structures_and_data_types.ipynb#defaultdict)
        - [OrderedDict](jupyter/01_data_structures_and_data_types.ipynb#ordereddict)
        - [Counter](jupyter/01_data_structures_and_data_types.ipynb#counter)
    - [Set](jupyter/01_data_structures_and_data_types.ipynb#set)
        - [Frozenset](jupyter/01_data_structures_and_data_types.ipynb#frozenset)
    - [Array](jupyter/01_data_structures_and_data_types.ipynb#array)
        - [Bytes](jupyter/01_data_structures_and_data_types.ipynb#bytes)
        - [Bytearray](jupyter/01_data_structures_and_data_types.ipynb#bytearray)
    - [Deque](jupyter/01_data_structures_and_data_types.ipynb#deque)
    - [Queue](jupyter/01_data_structures_and_data_types.ipynb#queue)
        - [LifoQueue](jupyter/01_data_structures_and_data_types.ipynb#lifoqueue)
        - [PriorityQueue](jupyter/01_data_structures_and_data_types.ipynb#priorityqueue)
    - [Heap queue (Heapq)](jupyter/01_data_structures_and_data_types.ipynb#heap)
3. [User-defined Data Structures](jupyter/01_data_structures_and_data_types.ipynb#user-defined-ds)
    - [Linked List](jupyter/01_data_structures_and_data_types.ipynb#linkedlist)
    - [Binary Tree](jupyter/01_data_structures_and_data_types.ipynb#binarytree)
    - [B-tree](jupyter/01_data_structures_and_data_types.ipynb#btree)
    - [Red-Black Tree](jupyter/01_data_structures_and_data_types.ipynb#redblacktree)
    - [AVL Tree](jupyter/01_data_structures_and_data_types.ipynb#avltree)
    - [Trie](jupyter/01_data_structures_and_data_types.ipynb#trie)
4. [Other Data Types](jupyter/01_data_structures_and_data_types.ipynb#other-dt)
    - [Enum](jupyter/01_data_structures_and_data_types.ipynb#enum)
    - [Range](jupyter/01_data_structures_and_data_types.ipynb#range)
    - [Dataclass](jupyter/01_data_structures_and_data_types.ipynb#dataclass)
    - [Struct](jupyter/01_data_structures_and_data_types.ipynb#struct)
    - [Datetime](jupyter/01_data_structures_and_data_types.ipynb#datetime)
        - [Constructors](jupyter/01_data_structures_and_data_types.ipynb#constructors)
        - [Now](jupyter/01_data_structures_and_data_types.ipynb#now)
        - [Timezone](jupyter/01_data_structures_and_data_types.ipynb#timezone)
5. [General Data Structure Concepts](jupyter/01_data_structures_and_data_types.ipynb#general-ds-concepts)
    - [Mutable/Immutable](jupyter/01_data_structures_and_data_types.ipynb#mutable-immutable)
    - [Hash calculation problem](jupyter/01_data_structures_and_data_types.ipynb#hashcalc)
