...
```
    ...
    Cell In[3], line 7
          3     return a + b
          6 # A static type checker can catch incompatible types before running the program
    ----> 7 print(add("10", 20))


    Cell In[3], line 3, in add(a, b)
...
![png](../markdown/09_python_language_interntals_files/../markdown/09_python_language_interntals_32_1.png)
